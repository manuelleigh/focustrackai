from focustrack.feature.bostezo import BostezoTracker
from focustrack.models import AttentionMetrics


def _metrics(mar, yawning):
...
def test_contador_incrementa_una_vez_por_bostezo():
    ...
    tracker.actualizar(_metrics(0.72, True))
...
def test_ignora_frame_sin_deteccion():
    tracker = BostezoTracker()
    tracker.actualizar(_metrics(None, False))
